...
elseif (isset($_POST['genere_btn'])) {
    $genere = mysqli_real_escape_string($conn, $_POST['genere_val']);
                    ...
                    <div class="left-container" id="left-container">
                        ...
                        <div class="genere-subwrap" id="genere-subwrap" style="display:none;">
                            <form action="lista.php" method="post">
                                ...
                                foreach ($generi as $g) {
                                    echo "
                                    <button type='submit' name='genere_btn' value='1' class='genere-sublink'>
                                        <input type='hidden' name='genere_val' value='$g'>$g
                                    </button>";
                                }
                                ?>
                            </form>
                ...
                <div class="right-column">
                    ...
                    if (mysqli_num_rows($queryResult) > 0) {
                        while ($row = mysqli_fetch_assoc($queryResult)) {
                            ...
                            // Output HTML con classi e strutture originali
                            echo "
                            <a href='/libro/libro.php?id=$id'>
                                <div class='book-list hvr-float data-single-book'>
                                    <img src='/" . $row['Copertina'] . "' width='113' height='171' class='book-img' style='object-fit: cover;'>
