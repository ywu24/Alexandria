...
NOTA2: installare PHP Composer da https://getcomposer.org/download/ ed eseguire "composer install" dal root del repo per installare le dipendenze (in composer.json)
